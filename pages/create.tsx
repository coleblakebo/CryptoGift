  ...
  return (
    <div className="page-root">
      <main className="card card-wide">
        ...
        <form className="gift-form" onSubmit={submit}>
          ...
          <label className="field">
            ...
            <input
              ...
              placeholder="izzy-d-easter-2026"
            />
          </label>
          ...
          <label className="field">
            ...
            <textarea
              ...
              placeholder="Happy Birthday! This is for your future. Love, Uncle Cole."
            />
          </label>
        ...
        {shareUrl ? (
          <section className="summary summary-success">
            <h2>Gift created</h2>
            ...
            <div className="actions">
              <a className="primary" href={shareUrl}>
                Open Gift
              </a>
            </div>
          </section>
